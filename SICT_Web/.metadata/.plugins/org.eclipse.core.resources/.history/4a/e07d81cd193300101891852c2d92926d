                ...
                <div class="col-md-8 d-flex flex-column justify-content-between">
                    <div>
                        <h5 class="fw-bold" style="color: #003399;">
                            <a href="xem-tuyen-sinh-sau-dai-hoc?matintuc=${news.maTinTuc}" style="text-decoration: none; color: inherit;">
                                ${news.tieuDeTinTuc}
                            </a>
                        </h5>
                    ...
                    <div>
                        <a href="xem-tuyen-sinh-sau-dai-hoc?matintuc=${news.maTinTuc}" class="fw-bold text-primary">Xem thêm</a>
                    </div>
                </div>
            </div>
        </c:forEach>

            ...
            <div class="clearfix">
                ...
                <ul class="pagination">
                    <c:if test="${currentPage > 1}">
                        <li class="page-item"><a href="manage?page=${currentPage - 1}" class="page-link" target="contentFrame">Trước</a></li>
                    </c:if>
                    <c:forEach begin="1" end="${totalPages}" var="i">
                        <li class="page-item ${currentPage == i ? 'active' : ''}">
                            <a href="manage?page=${i}" class="page-link" target="contentFrame">${i}</a>
                        </li>
                    </c:forEach>
                    <c:if test="${currentPage < totalPages}">
                        <li class="page-item"><a href="manage?page=${currentPage + 1}" class="page-link" target="contentFrame">Sau</a></li>
                    </c:if>
                </ul>
            </div>
        </div>

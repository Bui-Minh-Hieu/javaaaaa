...
<head>
    ...
    <title><c:out value="${news != null ? news.tieuDeTinTuc : 'Tin Tức Tuyển Sinh Đại Học'}"/></title>
                    ...
                    <div class="news-detail">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<%= request.getContextPath() %>/tuyen-sinh-dai-hoc">Tuyển Sinh Đại Học</a></li>

...
public class TinTuc {
    ...
    public TinTuc(int maTinTuc, String tieuDeTinTuc, String urlAnh, String trichDanTin, String noiDungTin, LocalDateTime ngayCapNhat, Integer soLanDoc, String tag, int maTheLoai, int maTheLoaiTin, int maPhanLoaiTin, int maThanhVien) {
    ...
    public String toString() {
        return "TinTuc{" +
                ...
                ", maPhanLoaiTin=" + maPhanLoaiTin +
                ", maThanhVien=" + maThanhVien +
                (theLoai != null ? ", theLoai=" + theLoai.getTenTheLoai() : "") +

...
public class TheLoaiTin {
    ...
    public TheLoaiTin(int maTheLoaiTin, String tenTheLoaiTin, boolean visibleTheLoaiTin, boolean visibleTheLoaiTin1, Integer sapXep, String url, String target, boolean linkNgoai, int maTheLoai) {
    ...
    public String toString() {
        return "TheLoaiTin{" +
                ...
                ", tenTheLoaiTin='" + tenTheLoaiTin + '\'' +
                ", visibleTheLoaiTin=" + visibleTheLoaiTin +
                ", visibleTheLoaiTin1=" + visibleTheLoaiTin1 +
                ", sapXep=" + sapXep +
                ", url='" + url + '\'' +
                ", target='" + target + '\'' +
                ", linkNgoai=" + linkNgoai +

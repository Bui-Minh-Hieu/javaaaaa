...
public class TheLoai {
    ...
    public TheLoai(int maTheLoai, String tenTheLoai, boolean visibleTheLoai, boolean visibleTheLoai1, Integer sapXep, String url, String target, boolean linkNgoai) {
    ...
    public String toString() {
        return "TheLoai{" +
                ...
                ", visibleTheLoai=" + visibleTheLoai +
                ", visibleTheLoai1=" + visibleTheLoai1 +
                ", sapXep=" + sapXep +
                ", url='" + url + '\'' +
                ", target='" + target + '\'' +
                ", linkNgoai=" + linkNgoai +
